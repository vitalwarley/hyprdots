...
[Document any research, investigation, or learning done during the session:]
- **Topic**: [What was researched — technology, concept, approach, tool]
- **Key findings**: [Conclusions, comparisons, evaluations reached]
- **Sources**: [Documentation, articles, repos, tools consulted]
- **Open questions**: [Unresolved items or areas needing further investigation]
- **Broader relevance**: [How findings could apply beyond this project's immediate context]

[If no research was done, write "N/A" — don't omit the section]
...
- **Capture research explicitly**: Web searches, doc reading, technology evaluations, conceptual explorations — all go in Research & Discoveries, even if they didn't lead to code changes. Always fill "Broader relevance" when findings could apply beyond the immediate task
